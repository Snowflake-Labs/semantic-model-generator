...
# TODO: Find a way to collect those from env. variable or local file or add a form
st.session_state["snowflake_stage"] = SnowflakeStage(
    "SNOWFLAKE_SEMANTIC_CONTEXT", "DEFINITIONS", "TEST"
)
...
with st.sidebar:
    ...
    if semantic_model_exists():
        ...
        st.session_state["last_validated_model"] = st.session_state.semantic_model
